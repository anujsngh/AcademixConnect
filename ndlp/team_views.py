...
def team_register():
    if request.method == "GET":
        ...
        team_mentor1 = Student.query.filter_by(email=team_mentor1_email).first()
        team_mentor2_email = request.form.get("team_mentor2_email")
        team_mentor2 = Student.query.filter_by(email=team_mentor2_email).first()
        ...
        if password == confirm_password:
            ...
            # team.mentors.append(team_mentor1)
            # team.mentors.append(team_mentor2)
...
def team_dashboard(team_uid):
    team_dict = Team.query.get_or_404(team_uid)
